...
# NOTE: in the APC config (through a browser), you must
#   configuration -> network -> SNMPv1 -> Access -> Enable
#   configuration -> network -> SNMPv1 -> Access Control -> Community Name 1:
#      community name, "public"
#      access type, "Read"
#   configuration -> network -> SNMPv1 -> Access Control -> Community Name 2:
#      community name, "private"
#      access type, "Write+"
#      (leave NMS IP/Host Name as 0.0.0.0)
...
class pdu():
    class __PduParameters():
        def __init__(self,base,config):
            ...
            self.load_config()
            self.logger = utils.setup_logger(self.base_directory,'pdu')
...
if __name__ == '__main__':
    pdu1 = pdu('/home/tres/tres-guider','pdu.ini')
